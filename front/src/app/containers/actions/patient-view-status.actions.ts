...
export enum PatientViewActionTypes {
    ...
    AppointmentHistory= '[AppointmentHistory] Appointment-History'
}
...
export class AppointmentHistory implements Action {
  readonly type = PatientViewActionTypes.AppointmentHistory;
